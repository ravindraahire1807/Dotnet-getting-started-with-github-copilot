              ...
              <ul class="participants-list">
                ${details.participants.map(email => `
                  <li style="list-style-type:none;display:flex;align-items:center;gap:6px;">
                    <span>${email}</span>
                    <span class="delete-participant" title="Unregister" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(email)}" style="cursor:pointer;color:#c62828;font-size:18px;user-select:none;">&#10006;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
